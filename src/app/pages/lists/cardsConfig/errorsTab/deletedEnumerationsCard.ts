...
export class DeletedEnumerationsCardConfig {

    private static path = 'errorLst';
    private static fieldProperty = 'deletedEnumerationLst';
            ...
            [{
                ...
                settings: {
                    columns: {
                        ...
                        enumeration: Translation.getErrorColumn(this.fieldProperty, 'enumeration')
                    },
                    actions: {
                        edit: false,
                        delete: false,
                        add: false,
                        custom: Translation.getCustomActions([Tab.DATA_GROUPS, Tab.ENUMERATIONS], translate)
                    }
                }
            }]
        ];
