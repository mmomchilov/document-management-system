...
export class DuplicatingSequencesCardConfig {

    private static path = 'errorLst';
    private static fieldProperty = 'doublingSequenceLst';
            ...
            [{
                ...
                settings: {
                    columns: {
                        ...
                        sequence: Translation.getErrorColumn(this.fieldProperty, 'field')
                    },
                    actions: {
                        edit: false,
                        delete: false,
