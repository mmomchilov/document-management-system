export class UtilCharts {
    ...
    static translatedDocumentTypeTable = [];
    ...
    static DocumentTypeTableColumns = [
        'ShortName', 'Description', 'Enabled', 'ModifiedBy', 'Modified'
    ];
    ...
    static translateRPTable1Columns(translateService) {
        this.translatedDocumentTypeTable = this.DocumentTypeTableColumns.map((columnName) => {
            return translateService.instant(`localizationResource.referential.dashboard.${columnName}.shortLabel`);
        });
    }
